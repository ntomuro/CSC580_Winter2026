# :school_satchel: CSC580 AI II (Winter 2026)

Code and file repository for assignments and project.

## :books: Assignments

Following assignments are planned so far (as of Jan 2026).

- Homework #1-2: :alien: K-armed Bandits
- Homework #2: :robot: Snake game
- Homework #3: :deciduous_tree: Essay on Select AI Topic (TBD)
- Homework #4: :dog: Atari Pong  (TBD)
